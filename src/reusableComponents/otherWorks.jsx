    ...
    const contentItems = [
        {
            ...
            summary: `The Content Shows is a one-evening exhibition project held four times between 2023 and 2024 at Folkteatern in Gothenburg, Sweden. The project challenges ideas about artistic merit, selection, and institutional power. Directors and curators are typically chosen for their acclaim or cultural capital, and they, in turn, select artists who align with their vision—creating a chain of expectations that can limit expression. The Content Shows operates on a simple principle: participation is determined by whoever signs up first on a physical list. What does an exhibition become when no one shapes the content but the artists themselves? The exhibitions were documented solely through text. `,
                                ...
                                <div key={item.id} className="border-none p-2 lg:w-2/3">
                                    <div className="flex flex-col items-center">
                                        ...
                                        <div className="w-full">
                                            ...
                                            <p className="text-sm italic text-gray-700">{item.summary}</p>
